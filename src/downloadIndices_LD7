...
var boundary = ee.FeatureCollection("users/escaduto/NEW_Study_Region_DIS"),
    ...
    ee.Geometry.Polygon(
        [[[-11.411944362220765, 32.536095207409865],
          [-11.411944362220765, 28.60229755153701],
          [-7.6765927997207655, 28.60229755153701],
          [-7.6765927997207655, 32.536095207409865]]], null, false);
